...
ARTI_URL_DEV=https://arti.dev.cray.com/artifactory/kj-docker-unstable-local/cray-dws-operator/
ARTI_URL_MASTER=https://arti.dev.cray.com/artifactory/kj-docker-master-local/cray-dws-operator/
...
if [[ "$CURRENT_BRANCH_NAME" == "master" ]] || [[ "$CURRENT_BRANCH_NAME" == "HEAD" ]]; then
    ...
    IMAGE_TAG_BASE=arti.dev.cray.com/kj-docker-unstable-local/cray-dws-operator
