	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DwsV1alpha1().Workflows(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DwsV1alpha1().Workflows(namespace).Watch(options)
			},
		},
		&dwsv1alpha1.Workflow{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workflowInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dwsv1alpha1.Workflow{}, f.defaultInformer)
}
