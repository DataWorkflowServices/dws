...
type StoragePoolInterface interface {
	...
	UpdateStatus(*v1alpha1.StoragePool) (*v1alpha1.StoragePool, error)
...
func newStoragePools(c *DwsV1alpha1Client, namespace string) *storagePools {
	return &storagePools{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *storagePools) UpdateStatus(storagePool *v1alpha1.StoragePool) (result *v1alpha1.StoragePool, err error) {
	result = &v1alpha1.StoragePool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagepools").
