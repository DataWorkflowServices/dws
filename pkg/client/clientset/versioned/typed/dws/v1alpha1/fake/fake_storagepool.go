...
func (c *FakeStoragePools) UpdateStatus(storagePool *v1alpha1.StoragePool) (*v1alpha1.StoragePool, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(storagepoolsResource, "status", c.ns, storagePool), &v1alpha1.StoragePool{})
