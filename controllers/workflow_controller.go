...
import (
	...
	"github.com/DataWorkflowServices/dwsforkcheck/controllers/metrics"
...
//+kubebuilder:rbac:groups=dws.dataworkflowservices.github.io,resources=workflows,verbs=get;list;watch;update;patch
//+kubebuilder:rbac:groups=dws.dataworkflowservices.github.io,resources=workflows/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=dws.dataworkflowservices.github.io,resources=workflows/finalizers,verbs=update
//+kubebuilder:rbac:groups=dws.dataworkflowservices.github.io,resources=computes,verbs=get;create;list;watch;update;patch;delete;deletecollection
