...
var dwDirectiveTests = []struct {
	...
	{[]string{"#DW jobdw type=lustre capacity=100GB name=CoolProfile1 profile=this-type-profile08"}, pass},
	{[]string{"#DW jobdw type=lustre capacity=100GB name=CoolProfile2 profile=this-type-profile08"}, pass},
	...
	{[]string{"#DW jobdw type=lustre capacity=100GB name=UncoolProfile5 profile"}, fail},

	{[]string{"#DW jobdw type=lustre capacity=100GB name=Bool1 boolcheck1"}, fail},
	{[]string{"#DW jobdw type=lustre capacity=100GB name=Bool2 boolcheck2"}, pass},
	{[]string{"#DW jobdw type=lustre capacity=100GB name=Bool3 boolcheck1=false"}, pass},
	{[]string{"#DW jobdw type=lustre capacity=100GB name=Bool4 boolcheck1=true"}, pass},
	{[]string{"#DW jobdw type=lustre capacity=100GB name=Bool5 boolcheck1=0"}, fail},
	{[]string{"#DW jobdw type=lustre capacity=100GB name=Bool6 boolcheck1=hello"}, fail},
	...
	{[]string{"#DW create_persistent type=lustre capacity=100GB name=CoolProfile1 profile=this-type-profile08"}, pass},
	{[]string{"#DW create_persistent type=lustre capacity=100GB name=CoolProfile2 profile=this-type-profile08"}, pass},
