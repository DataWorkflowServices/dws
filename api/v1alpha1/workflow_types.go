...
const (
	// Workflow Name Label is defined for resource that relate to the name of a DWS Workflow
	WorkflowNameLabel = "dws.cray.hpe.com/workflow.name"

	// Workflow Namespace label is defined for resource that relate to the namespace of a DWS Workflow
