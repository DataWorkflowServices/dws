...
func (src *ClientMount) ConvertTo(dstRaw conversion.Hub) error {
	...
	dst := dstRaw.(*dwsv1alpha6.ClientMount)

	if err := Convert_v1alpha1_ClientMount_To_v1alpha6_ClientMount(src, dst, nil); err != nil {
		return err
	}

	// Manually restore data.
	restored := &dwsv1alpha6.ClientMount{}
	...
	if src.Status.Error != nil && !src.Status.Error.Recoverable {
		dst.Status.Error.Severity = dwsv1alpha6.SeverityFatal
	}
...
func (dst *ClientMount) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*dwsv1alpha6.ClientMount)
	convertlog.Info("Convert ClientMount From Hub", "name", src.GetName(), "namespace", src.GetNamespace())

	if err := Convert_v1alpha6_ClientMount_To_v1alpha1_ClientMount(src, dst, nil); err != nil {
		return err
	}
	...
	if src.Status.Error != nil {
		if src.Status.Error.Severity == dwsv1alpha6.SeverityFatal {
...
func (src *Computes) ConvertTo(dstRaw conversion.Hub) error {
	...
	dst := dstRaw.(*dwsv1alpha6.Computes)

	if err := Convert_v1alpha1_Computes_To_v1alpha6_Computes(src, dst, nil); err != nil {
		return err
	}

	// Manually restore data.
	restored := &dwsv1alpha6.Computes{}
...
func (dst *Computes) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*dwsv1alpha6.Computes)
	convertlog.Info("Convert Computes From Hub", "name", src.GetName(), "namespace", src.GetNamespace())

	if err := Convert_v1alpha6_Computes_To_v1alpha1_Computes(src, dst, nil); err != nil {
		return err
	}
...
func (src *DWDirectiveRule) ConvertTo(dstRaw conversion.Hub) error {
	...
	dst := dstRaw.(*dwsv1alpha6.DWDirectiveRule)

	if err := Convert_v1alpha1_DWDirectiveRule_To_v1alpha6_DWDirectiveRule(src, dst, nil); err != nil {
		return err
	}

	// Manually restore data.
	restored := &dwsv1alpha6.DWDirectiveRule{}
	if ok, err := utilconversion.UnmarshalData(src, restored); err != nil || !ok {
		return err
	}
	// EDIT THIS FUNCTION! If the annotation is holding anything that is
...
func (dst *DWDirectiveRule) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*dwsv1alpha6.DWDirectiveRule)
	convertlog.Info("Convert DWDirectiveRule From Hub", "name", src.GetName(), "namespace", src.GetNamespace())

	if err := Convert_v1alpha6_DWDirectiveRule_To_v1alpha1_DWDirectiveRule(src, dst, nil); err != nil {
		return err
	}
...
func (src *DirectiveBreakdown) ConvertTo(dstRaw conversion.Hub) error {
	...
	dst := dstRaw.(*dwsv1alpha6.DirectiveBreakdown)

	if err := Convert_v1alpha1_DirectiveBreakdown_To_v1alpha6_DirectiveBreakdown(src, dst, nil); err != nil {
		return err
	}

	// Manually restore data.
	restored := &dwsv1alpha6.DirectiveBreakdown{}
	hasAnno, err := utilconversion.UnmarshalData(src, restored)
	if err != nil {
		return err
	}
...
func (dst *DirectiveBreakdown) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*dwsv1alpha6.DirectiveBreakdown)
	convertlog.Info("Convert DirectiveBreakdown From Hub", "name", src.GetName(), "namespace", src.GetNamespace())

	if err := Convert_v1alpha6_DirectiveBreakdown_To_v1alpha1_DirectiveBreakdown(src, dst, nil); err != nil {
		return err
	}
...
func (src *PersistentStorageInstance) ConvertTo(dstRaw conversion.Hub) error {
	...
	dst := dstRaw.(*dwsv1alpha6.PersistentStorageInstance)

	if err := Convert_v1alpha1_PersistentStorageInstance_To_v1alpha6_PersistentStorageInstance(src, dst, nil); err != nil {
		return err
	}

	// Manually restore data.
	restored := &dwsv1alpha6.PersistentStorageInstance{}
	hasAnno, err := utilconversion.UnmarshalData(src, restored)
	if err != nil {
		return err
	}
...
func (dst *PersistentStorageInstance) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*dwsv1alpha6.PersistentStorageInstance)
	convertlog.Info("Convert PersistentStorageInstance From Hub", "name", src.GetName(), "namespace", src.GetNamespace())

	if err := Convert_v1alpha6_PersistentStorageInstance_To_v1alpha1_PersistentStorageInstance(src, dst, nil); err != nil {
		return err
	}
...
func (src *Servers) ConvertTo(dstRaw conversion.Hub) error {
	...
	dst := dstRaw.(*dwsv1alpha6.Servers)

	if err := Convert_v1alpha1_Servers_To_v1alpha6_Servers(src, dst, nil); err != nil {
		return err
	}

	// Manually restore data.
	restored := &dwsv1alpha6.Servers{}
	hasAnno, err := utilconversion.UnmarshalData(src, restored)
	if err != nil {
		return err
	}
	...
	if hasAnno {
		...
		if restored.Status.Error != nil {
			...
			dst.Status.Error = dwsv1alpha6.NewResourceError("")
...
func (dst *Servers) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*dwsv1alpha6.Servers)
	convertlog.Info("Convert Servers From Hub", "name", src.GetName(), "namespace", src.GetNamespace())

	if err := Convert_v1alpha6_Servers_To_v1alpha1_Servers(src, dst, nil); err != nil {
		return err
	}
...
func (src *Storage) ConvertTo(dstRaw conversion.Hub) error {
	...
	dst := dstRaw.(*dwsv1alpha6.Storage)

	if err := Convert_v1alpha1_Storage_To_v1alpha6_Storage(src, dst, nil); err != nil {
		return err
	}

	// Manually restore data.
	restored := &dwsv1alpha6.Storage{}
	if ok, err := utilconversion.UnmarshalData(src, restored); err != nil || !ok {
		return err
	}
	// EDIT THIS FUNCTION! If the annotation is holding anything that is
...
func (dst *Storage) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*dwsv1alpha6.Storage)
	convertlog.Info("Convert Storage From Hub", "name", src.GetName(), "namespace", src.GetNamespace())

	if err := Convert_v1alpha6_Storage_To_v1alpha1_Storage(src, dst, nil); err != nil {
		return err
	}
...
func (src *SystemConfiguration) ConvertTo(dstRaw conversion.Hub) error {
	...
	dst := dstRaw.(*dwsv1alpha6.SystemConfiguration)

	if err := Convert_v1alpha1_SystemConfiguration_To_v1alpha6_SystemConfiguration(src, dst, nil); err != nil {
		return err
	}

	// Manually restore data.
	restored := &dwsv1alpha6.SystemConfiguration{}
	hasAnno, err := utilconversion.UnmarshalData(src, restored)
	if err != nil {
		return err
	}
	...
	if hasAnno {
		...
		dstExternComputes := make([]dwsv1alpha6.SystemConfigurationExternalComputeNode, len(externComputes))
		idx := 0
...
func (dst *SystemConfiguration) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*dwsv1alpha6.SystemConfiguration)
	convertlog.Info("Convert SystemConfiguration From Hub", "name", src.GetName(), "namespace", src.GetNamespace())

	if err := Convert_v1alpha6_SystemConfiguration_To_v1alpha1_SystemConfiguration(src, dst, nil); err != nil {
		return err
	}
...
func (src *Workflow) ConvertTo(dstRaw conversion.Hub) error {
	...
	dst := dstRaw.(*dwsv1alpha6.Workflow)

	if err := Convert_v1alpha1_Workflow_To_v1alpha6_Workflow(src, dst, nil); err != nil {
		return err
	}

	// Manually restore data.
	restored := &dwsv1alpha6.Workflow{}
	hasAnno, err := utilconversion.UnmarshalData(src, restored)
	if err != nil {
		return err
	}
...
func (dst *Workflow) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*dwsv1alpha6.Workflow)
	convertlog.Info("Convert Workflow From Hub", "name", src.GetName(), "namespace", src.GetNamespace())

	if err := Convert_v1alpha6_Workflow_To_v1alpha1_Workflow(src, dst, nil); err != nil {
		return err
	}
...
func Convert_v1alpha6_ClientMountStatus_To_v1alpha1_ClientMountStatus(in *dwsv1alpha6.ClientMountStatus, out *ClientMountStatus, s apiconversion.Scope) error {
	return autoConvert_v1alpha6_ClientMountStatus_To_v1alpha1_ClientMountStatus(in, out, s)
}

func Convert_v1alpha6_DirectiveBreakdownStatus_To_v1alpha1_DirectiveBreakdownStatus(in *dwsv1alpha6.DirectiveBreakdownStatus, out *DirectiveBreakdownStatus, s apiconversion.Scope) error {
	return autoConvert_v1alpha6_DirectiveBreakdownStatus_To_v1alpha1_DirectiveBreakdownStatus(in, out, s)
}

func Convert_v1alpha1_ResourceErrorInfo_To_v1alpha6_ResourceErrorInfo(in *ResourceErrorInfo, out *dwsv1alpha6.ResourceErrorInfo, s apiconversion.Scope) error {
	return autoConvert_v1alpha1_ResourceErrorInfo_To_v1alpha6_ResourceErrorInfo(in, out, s)
}

func Convert_v1alpha6_ResourceErrorInfo_To_v1alpha1_ResourceErrorInfo(in *dwsv1alpha6.ResourceErrorInfo, out *ResourceErrorInfo, s apiconversion.Scope) error {
	return autoConvert_v1alpha6_ResourceErrorInfo_To_v1alpha1_ResourceErrorInfo(in, out, s)
}

func Convert_v1alpha6_ServersStatus_To_v1alpha1_ServersStatus(in *dwsv1alpha6.ServersStatus, out *ServersStatus, s apiconversion.Scope) error {
	return autoConvert_v1alpha6_ServersStatus_To_v1alpha1_ServersStatus(in, out, s)
}

func Convert_v1alpha1_WorkflowSpec_To_v1alpha6_WorkflowSpec(in *WorkflowSpec, out *dwsv1alpha6.WorkflowSpec, s apiconversion.Scope) error {
	return autoConvert_v1alpha1_WorkflowSpec_To_v1alpha6_WorkflowSpec(in, out, s)
}

func Convert_v1alpha6_WorkflowSpec_To_v1alpha1_WorkflowSpec(in *dwsv1alpha6.WorkflowSpec, out *WorkflowSpec, s apiconversion.Scope) error {
	return autoConvert_v1alpha6_WorkflowSpec_To_v1alpha1_WorkflowSpec(in, out, s)
}

func Convert_v1alpha1_SystemConfigurationSpec_To_v1alpha6_SystemConfigurationSpec(in *SystemConfigurationSpec, out *dwsv1alpha6.SystemConfigurationSpec, s apiconversion.Scope) error {
	return autoConvert_v1alpha1_SystemConfigurationSpec_To_v1alpha6_SystemConfigurationSpec(in, out, s)
}

func Convert_v1alpha6_SystemConfigurationSpec_To_v1alpha1_SystemConfigurationSpec(in *dwsv1alpha6.SystemConfigurationSpec, out *SystemConfigurationSpec, s apiconversion.Scope) error {
	return autoConvert_v1alpha6_SystemConfigurationSpec_To_v1alpha1_SystemConfigurationSpec(in, out, s)
}

func Convert_v1alpha6_StorageSpec_To_v1alpha1_StorageSpec(in *dwsv1alpha6.StorageSpec, out *StorageSpec, s apiconversion.Scope) error {
	return autoConvert_v1alpha6_StorageSpec_To_v1alpha1_StorageSpec(in, out, s)
}

func Convert_v1alpha6_WorkflowStatus_To_v1alpha1_WorkflowStatus(in *dwsv1alpha6.WorkflowStatus, out *WorkflowStatus, s apiconversion.Scope) error {
	return autoConvert_v1alpha6_WorkflowStatus_To_v1alpha1_WorkflowStatus(in, out, s)
}

func Convert_v1alpha6_SystemConfigurationStatus_To_v1alpha1_SystemConfigurationStatus(in *dwsv1alpha6.SystemConfigurationStatus, out *SystemConfigurationStatus, s apiconversion.Scope) error {
	return autoConvert_v1alpha6_SystemConfigurationStatus_To_v1alpha1_SystemConfigurationStatus(in, out, s)
}

func Convert_v1alpha6_ServersStatusStorage_To_v1alpha1_ServersStatusStorage(in *dwsv1alpha6.ServersStatusStorage, out *ServersStatusStorage, s apiconversion.Scope) error {
	return autoConvert_v1alpha6_ServersStatusStorage_To_v1alpha1_ServersStatusStorage(in, out, s)
}
