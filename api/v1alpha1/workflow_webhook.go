...
import (
	...
	"github.com/DataWorkflowServices/dwsforkcheck/utils/dwdparse"
)

//+kubebuilder:rbac:groups=dws.dataworkflowservices.github.io,resources=dwdirectiverules,verbs=get;list;watch
...
//+kubebuilder:webhook:path=/mutate-dws-dataworkflowservices-github-io-v1alpha1-workflow,mutating=true,failurePolicy=fail,sideEffects=None,groups=dws.dataworkflowservices.github.io,resources=workflows,verbs=create;update,versions=v1alpha1,name=mworkflow.kb.io,admissionReviewVersions={v1,v1beta1}
...
//+kubebuilder:webhook:path=/validate-dws-dataworkflowservices-github-io-v1alpha1-workflow,mutating=false,failurePolicy=fail,sideEffects=None,groups=dws.dataworkflowservices.github.io,resources=workflows,verbs=create;update,versions=v1alpha1,name=vworkflow.kb.io,admissionReviewVersions={v1,v1beta1}
